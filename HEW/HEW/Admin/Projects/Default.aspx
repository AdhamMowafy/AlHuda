...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="panel">
        <ContentTemplate>
            <asp:GridView ID="gvProjects" runat="server" AllowPaging="True" AllowSorting="True" DataSourceID="ldsProjects" PageSize="5" AutoGenerateColumns="False" AutoGenerateDeleteButton="True">
                <Columns>
