<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="HEW.Admin.NewsLetter.Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadPlaceHolder" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
	<script type="text/javascript" src="/Admin/Content/tinymce/jscripts/tiny_mce/tiny_mce.js"></script>
	...
	<div id="rightside">
		<div class="contentcontainer med left">
			<div class="headings alt" style="width: 800px">
				<h2>Newsletter</h2>
			</div>
			<div class="contentbox" style="width: 810px">
				<form action="#">
					<p>
						<label for="<%=txtNewsletter.ClientID %>"><strong>Number of Registered Users: <%=strRegisteredUsers %></strong></label>
						<textarea id="txtNewsletter" name="elm1" rows="15" cols="80" style="width: 80%" runat="server"></textarea>
					</p>
